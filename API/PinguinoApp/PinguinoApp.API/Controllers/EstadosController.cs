...
namespace PinguinoApp.API.Controllers
{
    ...
    public class EstadosController : Controller
    {
        ...
        [HttpPost("one")]
        public async Task<ActionResult<dynamic>> Insert([FromBody] Estado entity)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<dynamic>> Insert([FromBody] IEnumerable<Estado> entities)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<ActionResult<dynamic>> Update([FromBody] Estado entity)
        {
            try
            {
