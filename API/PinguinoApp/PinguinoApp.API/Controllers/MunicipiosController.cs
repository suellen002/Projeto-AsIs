...
namespace PinguinoApp.API.Controllers
{
    ...
    public class MunicipiosController : Controller
    {
        ...
        [HttpPost("one")]
        public async Task<ActionResult<dynamic>> Insert([FromBody] Municipio entity)
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<dynamic>> Insert([FromBody] IEnumerable<Municipio> entities)
        {
            try
            {
        ...
        [HttpPut]
        public async Task<ActionResult<dynamic>> Update([FromBody] Municipio entity)
        {
            try
            {
